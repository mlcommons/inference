...
The master of this repository contains ***work in progress*** for the next official (***1.1***) release. 

***At this point the model list for 1.1 is not finalized***.
...
## MLPerf Inference v1.1 (submission 03/12/2020)
