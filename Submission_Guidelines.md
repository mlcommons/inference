...
2. Closed submission under edge category needs single stream, multi-stream (only for R50 and retinanet) and offline scenarios. Minimum ten minutes are needed for each scenario. 
