...
class Waymo(dataset.Dataset):
    ...
    def __init__(self, data_root, split, pts_prefix='velodyne_reduced', painted=True, cam_sync=False):
        super().__init__()
    ...
    def get_item(self, id):
        ...
        data_dict = point_range_filter(data_dict, point_range=self.point_range_filter)
        images = []
        for i in range(5):
