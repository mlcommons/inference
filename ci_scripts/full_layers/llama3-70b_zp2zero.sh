...
MODEL_DATA_DIR=/home/home-mcl/phil/actions-runner/_work/data/quantization/llama3-70b/
...
if [ "$CALIBRATE" = true ]; then
    QUANT_PARAM_PATH=/home/home-mcl/phil/actions-runner/_work/data/furiosa_llm_modles_artifacts/quantized/meta-llama/Meta-Llama-3.1-70B-Instruct/mlperf_submission_slice/W8A8KV8/80L/quant_param_zp2zero.npy
    QUANT_FORMAT_PATH=/home/home-mcl/phil/actions-runner/_work/data/furiosa_llm_modles_artifacts/quantized/meta-llama/Meta-Llama-3.1-70B-Instruct/mlperf_submission_slice/W8A8KV8/80L/quant_format.yaml
    OUTPUT_PATH=$LOG_PATH/calibration_range/
    printf "\tNUM_CALIB_DATA: $N_CALIB\n"
    python -m quantization.extract_bin_file_llama3\
...
# python -m ci_file.qllama3_forward_test  --model_path=$CHECKPOINT_PATH \
#                                             --quant_config_path=$QUANT_CONFIG_PATH \
