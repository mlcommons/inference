...
MODEL_DATA_DIR=/home/home-mcl/phil/actions-runner/_work/data/quantization/llama2-70b/
log_dir=$git_dir/logs
CONFIG_DTYPE=fp8
QUANT_CONFIG_PATH=$MODEL_DATA_DIR/quant_config_$CONFIG_DTYPE.yaml
QUANT_DATA_PATH=$data_dir/furiosa_llm_modles_artifacts/quantized/meta-llama/Llama-2-70b-chat-hf/mlperf_submission_slice/W8fA8fKV8f/80L
...
python -m ci_file.qllama2_load_test  --model_path=$MODEL_PATH \
                                    --quant_config_path=$QUANT_CONFIG_PATH \
                                    --quant_data_path=$QUANT_DATA_PATH

printf "\n============= End of Test for llama2-70b =============\n"
