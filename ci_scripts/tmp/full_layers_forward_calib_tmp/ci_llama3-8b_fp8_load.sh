...
quant_data_path=/home/home-mcl/phil/actions-runner/_work/inference/inference/logs/llama3.1-8b/Offline/W8fA8fKV8f/20240913_193208UTC/calibration_range/
...
python -m ci_file.qllama3_load_test  --model_path=$CHECKPOINT_PATH \
                                            --quant_config_path=$QUANT_CONFIG_PATH \
