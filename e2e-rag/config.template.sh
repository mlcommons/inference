...
INGESTION_RETRIEVER_MODEL="intfloat_e5-base-v2/e5-base-v2"
...
INFERENCE_RETRIEVER_MODEL="intfloat_e5-base-v2/e5-base-v2"
...
INFERENCE_ORACLE_DATASET="frames-benchmark-dataset/frames_dataset.tsv"
