...
# Datasetup performance test script for E2E-RAG-Datasetup workload with MLPerf Loadgen
...
export MAX_WORKERS=${MAX_WORKERS:-4}  # Parallel processing (4 threads)
