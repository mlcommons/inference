...
log = logging.getLogger("DeepSeek-R1-Dataset")
...
class Dataset:
    def __init__(
        ...
        self.model_name = model_name or f"deepseek-ai/DeepSeek-R1-0528"
    ...
    def load_processed_dataset(self):
        ...
        self.input = self.processed_data.text_input.tolist()
        self.input_ids = self.processed_data.tok_input.tolist()
        self.input_lens = [len(x) for x in self.input_ids]
        self.targets = self.processed_data.ref_output.tolist()
