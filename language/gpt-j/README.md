...
Please download the internal [fine-tuned GPT-J checkpoint](https://cloud.mlcommons.org/index.php/s/QAZ2oM94MkFtbQx) and rename it as model/. The download_gptj.py only downloads the default huggingface model which is not fine-tuned on CNN-Daily mail dataset.
