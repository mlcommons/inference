...
```
export CHECKPOINT_PATH=meta-llama/Meta-Llama-3-8B-Instruct
git lfs install
git clone https://huggingface.co/meta-llama/Llama-3-8B-Instruct ${CHECKPOINT_PATH}
...
**Note:**
Downloading llama3-8b model from Hugging Face will require an [**access token**](https://huggingface.co/settings/tokens) which could be generated for your account. Additionally, ensure that your account has access to the [llama3-8b](https://huggingface.co/meta-llama/Llama-3-8B-Instruct) model. 
