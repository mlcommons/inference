...
```
export CHECKPOINT_PATH=Meta-Llama-3.1-8B-Instruct
git lfs install
...
**Note:**
Downloading llama3.1-8b model from Hugging Face will require an [**access token**](https://huggingface.co/settings/tokens) which could be generated for your account. Additionally, ensure that your account has access to the [llama3.1-8b](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct) model. 
...
```
rclone copy mlc-inference:mlcommons-inference-wg-public/llama3.1_8b/mlperf_llama3.1_8b_dataset_13368_processed_fp16_eval.pkl ./ -P
```
**MLC Command**
...
```
rclone copy mlc-inference:mlcommons-inference-wg-public/llama3.1_8b/mlperf_llama3.1_8b_calibration_dataset_512_processed_fp16_eval.pkl ./ -P
```
