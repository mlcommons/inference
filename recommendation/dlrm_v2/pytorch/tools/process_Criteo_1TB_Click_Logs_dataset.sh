...
date
python npy_preproc_criteo.py --input_dir "$raw_tsv_criteo_files_dir" --output_dir "$step_1_output_dir" || exit
...
date
python contiguous_preproc_criteo.py --input_dir "$step_1_output_dir" --output_dir "$step_2_output_dir" --frequency_threshold 0 || exit

date

name="$step_2_output_dir/day_23_sparse_contig_freq.npy"
renamed="$step_2_output_dir/day_23_sparse.npy"
