...
SUPPORTED_DATASETS = {
    ...
    "coco-1200-pt":
        (coco.Coco, dataset.pre_process_coco_resnet34, coco.PostProcessCocoPt(True,0.05),
         {"image_size": [1200, 1200, 3]}),
    "coco-1200-native-tf":
        (coco.Coco, dataset.pre_process_coco_resnet34_tf, coco.PostProcessCocoTfNative(),
         {"image_size": [1200, 1200, 3]}),
    "coco-1200-tf":
...
SUPPORTED_PROFILES = {
    ...
    "ssd-resnet34-tf": {
        "inputs": "image:0",
        "outputs": "ssd1200/concat_1:0,ssd1200/concat:0",
        "dataset": "coco-1200-tf",
        "backend": "tensorflow",
        "data-format": "NHWC",
    },
    # ssd-resnet34, built-in post process
