...
| BERT-Large | ONNX | f1_score=TBD | SQuAD v1.1 validation set | [from zenodo](https://zenodo.org/record/3739583) | Fine-tuned based on the PyTorch model and converted with [bert_tf_to_pytorch.py](bert_tf_to_pytorch.py) | int8, symetrically per-tensor quantized without bias | |
