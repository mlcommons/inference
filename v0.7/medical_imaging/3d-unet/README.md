...
| ----- | --------- | -------- | ------- | ---------- | ------------ | --------- | ----- |
| 3D-Unet | PyTorch | ??? | BraTS 2019 (last? 20% of Training dataset) | [from zenodo]() | | fp32 | |
...
- The input to the SUT is a volume of size `[4, 128, 128, 128]`. The output from SUT is a volume of size `[4, 128, 128, 128]` with predicted label logits for each voxel.
