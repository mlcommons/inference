...
You can find a short tutorial how to use this benchmark [here](https://github.com/mlcommons/inference/blob/r0.7_merge/vision/classification_and_detection/GettingStarted.ipynb).
...
| ssd-mobilenet 300x300 | onnx | mAP 0.23 | coco resized to 300x300 | [from zenodo](https://zenodo.org/record/3163026/files/ssd_mobilenet_v1_coco_2018_01_28.onnx) | [from tensorflow](http://download.tensorflow.org/models/object_detection/ssd_mobilenet_v1_coco_2018_01_28.tar.gz) converted with [this script](https://github.com/mlcommons/inference/blob/r0.7_merge/vision/classification_and_detection/tools/ssd-mobilenet-to-onnx.sh) | fp32 | NHWC, tested on onnxruntime, some runtime warnings |
